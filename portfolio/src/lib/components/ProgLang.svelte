<script lang="ts">
    ...
    let { name = $bindable(), size = 1, boxShadow = false }: Props = $props();
    ...
    > = {
        ...
        rust: {
            deviconName: "rust",
            fullName: "Rust",
            color: "#AE5909", // Rust orange
        },
        github: {
            deviconName: "github",
            fullName: "GitHub",
            color: "#3D3D3D", // GitHub gray
        },
        postgresql: {
            deviconName: "postgresql",
            fullName: "PostgreSQL",
            color: "#3379C0", // PostgreSQL blue
        },
        laravel: {
            deviconName: "laravel",
            fullName: "Laravel",
